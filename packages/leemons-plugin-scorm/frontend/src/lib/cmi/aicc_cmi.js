...
export class CMIStudentDemographics extends BaseCMI {
   ...
   */
  set city(city) {
    !this.initialized ? (this.#city = city) : throwReadOnlyError();
  }
   ...
   */
  set class(clazz) {
    !this.initialized ? (this.#class = clazz) : throwReadOnlyError();
  }
   ...
   */
  set company(company) {
    !this.initialized ? (this.#company = company) : throwReadOnlyError();
  }
   ...
   */
  set country(country) {
    !this.initialized ? (this.#country = country) : throwReadOnlyError();
  }
  ...
  set experience(experience) {
    !this.initialized ? (this.#experience = experience) : throwReadOnlyError();
  }
   ...
   */
  set title(title) {
    !this.initialized ? (this.#title = title) : throwReadOnlyError();
  }
   ...
   */
  set state(state) {
    !this.initialized ? (this.#state = state) : throwReadOnlyError();
  }
  ...
  set telephone(telephone) {
    !this.initialized ? (this.#telephone = telephone) : throwReadOnlyError();
  }
